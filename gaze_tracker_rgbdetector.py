...
Same approach as wrist_rotation_app.py
"""
import cv2
import numpy as np
...
# Try to import RGBHandDetector (from your project structure)
try:
    import sys
    ...
    print(f"ERROR: {e}")
    print("Make sure your wrist_rotation project is at:")
    print("  C:/Users/s-ridoy_d1/Desktop/wrist_rotation/")
...
class GazeTracker:
    ...
    def run(self):
        ...
        # Use RGBHandDetector (same as wrist rotation app)
        ...
        while True:
            # Get frame using RGBHandDetector (same as wrist rotation)
            ...
            if results.multi_face_landmarks:
                ...
                cv2.putText(frame, "No face detected - Look at camera", (10, h//2),
